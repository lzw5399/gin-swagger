...
[![Build Status](https://github.com/lzw5399/gin-swagger/actions/workflows/ci.yml/badge.svg?branch=master)](https://github.com/features/actions)
[![Codecov branch](https://img.shields.io/codecov/c/github/lzw5399/gin-swagger/master.svg)](https://codecov.io/gh/lzw5399/gin-swagger)
[![Go Report Card](https://goreportcard.com/badge/github.com/lzw5399/gin-swagger)](https://goreportcard.com/report/github.com/lzw5399/gin-swagger)
[![GoDoc](https://godoc.org/github.com/lzw5399/gin-swagger?status.svg)](https://godoc.org/github.com/lzw5399/gin-swagger)
[![Release](https://img.shields.io/github/release/lzw5399/gin-swagger.svg?style=flat-square)](https://github.com/lzw5399/gin-swagger/releases)
...
4. Download [gin-swagger](https://github.com/lzw5399/gin-swagger) by using:

```sh
go get -u github.com/lzw5399/gin-swagger
...
```go
import "github.com/lzw5399/gin-swagger" // gin-swagger middleware
...
import (
   ...
   ginSwagger "github.com/lzw5399/gin-swagger"
   "net/http"
)
// @BasePath /api/v1
